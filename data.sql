...
INSERT INTO wp_cesqt_grupos(`nombre`, `nombrelimpio`, `descripcion`) VALUES ('RECURSOS', 'Nombre Limpio', 'Las afirmaciones que siguen tienen que ver con la disponibilidad de recursos (materiales y humanos) necesarios para los profesionales que atienden a personas. Para responder, eliga la opción que mejor refleje su situación de acuerdo con la siguiente escala. Valore en qué grado en su unidad dispone de:');
